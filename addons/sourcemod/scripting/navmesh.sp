...
{
	return view_as<int>(NavMeshCollectSurroundingAreas(view_as<int>(GetNativeCell(1)), view_as<float>(GetNativeCell(2)), view_as<float>(GetNativeCell(3)), view_as<float>(GetNativeCell(4))));
}
